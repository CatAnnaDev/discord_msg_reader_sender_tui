...
pub const SETTINGS: &[SettingRow] = &[
    SettingRow {
        label: "Desktop toasts (DM popups)",
    ...
    SettingRow {
        label: "Notify on @mentions (servers)",
        kind: SettingKind::Bool,
    },
    SettingRow {
    ...
    SettingRow {
        label: "Voice output device",
        kind: SettingKind::Text,
    },
    SettingRow {
        label: "RX audio filters (HPF/gate/comp/AGC)",
        kind: SettingKind::Bool,
    },
    SettingRow {
        label: "TX audio filters (HPF/gate/comp/AGC)",
        kind: SettingKind::Bool,
    },
];
...
pub struct AppState {
    ...
    pub stream_conns: HashMap<u64, tokio::sync::mpsc::UnboundedSender<crate::voice::VoiceCommand>>,
    pub golive_key: Option<String>,
    pub golive_cmd_tx: Option<tokio::sync::mpsc::UnboundedSender<crate::voice::VoiceCommand>>,
